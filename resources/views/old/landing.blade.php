...
<body>
			...
			<nav class="s-header__nav js__scrollbar">
				<div class="container-fluid">
					...
					<ul class="list-unstyled s-header__nav-menu">
						<li class="s-header__nav-menu-item"><a class="s-header__nav-menu-link s-header__nav-menu-link-divider -is-active" href="/">Corporate</a></li>
	...
	<div class="s-swiper js__swiper-one-item">
		...
		<div class="swiper-wrapper">
			<div class="g-fullheight--xs g-bg-position--center swiper-slide" style="background-image: url(/raw_assets/main/img/1920x1080/02.jpg);">
				<div class="container g-text-center--xs g-ver-center--xs">
					<div class="g-margin-b-30--xs">
						<h1 class="g-font-size-35--xs g-font-size-45--sm g-font-size-55--md g-color--white">A web Experience<br>That Inspires You</h1>
					</div>
			...
			<div class="g-fullheight--xs g-bg-position--center swiper-slide" style="background-image: url(/raw_assets/main/img/1920x1080/01.jpg);">
				<div class="container g-text-center--xs g-ver-center--xs">
					<div class="g-margin-b-30--xs">
						<div class="g-margin-b-30--xs">
	...
	<!--========== PAGE CONTENT ==========-->
	<!-- Features -->
	<div id="js__scroll-to-section" class="features container g-padding-y-80--xs g-padding-y-125--sm">
		<div class="g-text-center--xs g-margin-b-100--xs">
			<p class="text-uppercase g-font-size-14--xs g-font-weight--700 g-color--primary g-letter-spacing--2 g-margin-b-25--xs">Welcome to megaCode</p>
	...
	<!-- Parallax -->
	<div class="js__parallax-window red-height" style="background: url(/raw_assets/main/img/1920x1080/03.jpg) 50% 0 no-repeat fixed;">

		<div class="parallax container g-text-center--xs g-padding-y-40--xs">
			<div class="">
				<h2 class="g-font-size-40--xs g-font-size-50--sm g-font-size-60--md g-color--white">The Fastest Way To Develop</h2>
			</div>
			<a href="{{ route('login') }}" class="text-uppercase s-btn s-btn--md s-btn--white-brd g-radius--50">Learn More</a>
		</div>
	</div>
	<!-- End Parallax -->
			...
			<div class="row">
				<div class="col-md-4 g-margin-t-15--xs g-margin-b-60--xs g-margin-b-0--lg">
					...
					<div class="wow fadeInLeft" data-wow-duration=".3" data-wow-delay=".3s">
						<h2 class="g-font-size-40--xs g-font-size-50--sm g-font-size-60--md">megaCode</h2>
					</div>
				</div>
	...
	<!-- Subscribe -->
	<div class="js__parallax-window" style="background: url(/raw_assets/main/img/1920x1080/07.jpg) 50% 0 no-repeat fixed;">
		...
		<div id="js__grid-portfolio-gallery" class="cbp">
			...
			<div class="s-portfolio__item cbp-item logos motion">
				<div class="s-portfolio__img-effect">
					<img src="/raw_assets/main/img/970x647/05.jpg" alt="Portfolio Image">
				</div>
				<div class="s-portfolio__caption-hover--cc">
					...
					<ul class="list-inline g-ul-li-lr-5--xs g-margin-b-0--xs">
						<li>
							<a href="/raw_assets/main/img/970x647/05.jpg" class="cbp-lightbox s-icon s-icon--sm s-icon--white-bg g-radius--circle" data-title="Portfolio Item <br/> by KeenThemes Inc.">
			...
			<div class="s-portfolio__item cbp-item graphic">
				<div class="s-portfolio__img-effect">
					<img src="/raw_assets/main/img/970x647/06.jpg" alt="Portfolio Image">
				</div>
				<div class="s-portfolio__caption-hover--cc">
					<div class="g-margin-b-25--xs">
						<h4 class="g-font-size-18--xs g-color--white g-margin-b-5--xs">Portfolio Item</h4>
					...
					<ul class="list-inline g-ul-li-lr-5--xs g-margin-b-0--xs">
						<li>
							<a href="/raw_assets/main/img/970x647/06.jpg" class="cbp-lightbox s-icon s-icon--sm s-icon--white-bg g-radius--circle" data-title="Portfolio Item <br/> by KeenThemes Inc.">
								<i class="fa fa-fullscreen"></i>
							</a>
						</li>
						<li>
			...
			<div class="s-portfolio__item cbp-item logos">
				<div class="s-portfolio__img-effect">
					<img src="/raw_assets/main/img/970x647/07.jpg" alt="Portfolio Image">
				</div>
				<div class="s-portfolio__caption-hover--cc">
					<div class="g-margin-b-25--xs">
						<h4 class="g-font-size-18--xs g-color--white g-margin-b-5--xs">Portfolio Item</h4>
					...
					<ul class="list-inline g-ul-li-lr-5--xs g-margin-b-0--xs">
						<li>
							<a href="/raw_assets/main/img/970x647/07.jpg" class="cbp-lightbox s-icon s-icon--sm s-icon--white-bg g-radius--circle" data-title="Portfolio Item <br/> by KeenThemes Inc.">
								<i class="fa fa-fullscreen"></i>
							</a>
						</li>
						<li>
			...
			<div class="s-portfolio__item cbp-item motion graphic">
				<div class="s-portfolio__img-effect">
					<img src="/raw_assets/main/img/970x647/08.jpg" alt="Portfolio Image">
				</div>
				<div class="s-portfolio__caption-hover--cc">
					<div class="g-margin-b-25--xs">
						<h4 class="g-font-size-18--xs g-color--white g-margin-b-5--xs">Portfolio Item</h4>
					...
					<ul class="list-inline g-ul-li-lr-5--xs g-margin-b-0--xs">
						<li>
							<a href="/raw_assets/main/img/970x647/08.jpg" class="cbp-lightbox s-icon s-icon--sm s-icon--white-bg g-radius--circle" data-title="Portfolio Item <br/> by KeenThemes Inc.">
								<i class="fa fa-fullscreen"></i>
							</a>
						</li>
						<li>
			...
			<div class="s-portfolio__item cbp-item logos graphic">
				<div class="s-portfolio__img-effect">
					<img src="/raw_assets/main/img/970x647/09.jpg" alt="Portfolio Image">
				</div>
				<div class="s-portfolio__caption-hover--cc">
					<div class="g-margin-b-25--xs">
						<h4 class="g-font-size-18--xs g-color--white g-margin-b-5--xs">Portfolio Item</h4>
					...
					<ul class="list-inline g-ul-li-lr-5--xs g-margin-b-0--xs">
						<li>
							<a href="/raw_assets/main/img/970x647/09.jpg" class="cbp-lightbox s-icon s-icon--sm s-icon--white-bg g-radius--circle" data-title="Portfolio Item <br/> by KeenThemes Inc.">
								<i class="fa fa-fullscreen"></i>
							</a>
						</li>
						<li>
			...
			<div class="s-portfolio__item cbp-item motion graphic">
				<div class="s-portfolio__img-effect">
					<img src="/raw_assets/main/img/970x647/04.jpg" alt="Portfolio Image">
				</div>
				<div class="s-portfolio__caption-hover--cc">
					<div class="g-margin-b-25--xs">
						<h4 class="g-font-size-18--xs g-color--white g-margin-b-5--xs">Portfolio Item</h4>
					...
					<ul class="list-inline g-ul-li-lr-5--xs g-margin-b-0--xs">
						<li>
							<a href="/raw_assets/main/img/970x647/04.jpg" class="cbp-lightbox s-icon s-icon--sm s-icon--white-bg g-radius--circle" data-title="Portfolio Item <br/> by KeenThemes Inc.">
								<i class="fa fa-fullscreen"></i>
							</a>
						</li>
						<li>
	...
	<!-- Testimonials -->
	<div class="js__parallax-window" style="background: url(/raw_assets/main/img/1920x1080/04.jpg) 50% 0 no-repeat fixed;">
				...
				<div class="swiper-wrapper">
					<div class="swiper-slide">
						<div class="wow fadeIn" data-wow-duration=".3" data-wow-delay=".1s">
							<img class="s-clients-v1" src="/raw_assets/main/img/clients/01-dark.png" alt="Clients Logo">
						</div>
					</div>
					<div class="swiper-slide">
						<div class="wow fadeIn" data-wow-duration=".3" data-wow-delay=".2s">
							<img class="s-clients-v1" src="/raw_assets/main/img/clients/02-dark.png" alt="Clients Logo">
						</div>
					</div>
					<div class="swiper-slide">
						<div class="wow fadeIn" data-wow-duration=".3" data-wow-delay=".3s">
							<img class="s-clients-v1" src="/raw_assets/main/img/clients/03-dark.png" alt="Clients Logo">
						</div>
					</div>
					<div class="swiper-slide">
						<div class="wow fadeIn" data-wow-duration=".3" data-wow-delay=".4s">
							<img class="s-clients-v1" src="/raw_assets/main/img/clients/04-dark.png" alt="Clients Logo">
						</div>
					</div>
					<div class="swiper-slide">
						<div class="wow fadeIn" data-wow-duration=".3" data-wow-delay=".5s">
							<img class="s-clients-v1" src="/raw_assets/main/img/clients/05-dark.png" alt="Clients Logo">
						</div>
					</div>
				</div>
			</div>
	...
	<!-- Counter -->
	<div class="js__parallax-window" style="background: url(/raw_assets/main/img/1920x1080/06.jpg) 50% 0 no-repeat fixed;">
		<div class="container g-padding-y-80--xs g-padding-y-125--sm">
			<div class="row">
	...
	<script type="text/javascript" src="/raw_assets/main/vendor/waypoint.min.js"></script>
	<script type="text/javascript" src="/raw_assets/main/vendor/counterup.min.js"></script>
	...
	<script type="text/javascript" src="/raw_assets/main/js/components/counter.min.js"></script>
	<script type="text/javascript" src="/raw_assets/main/js/components/portfolio-3-col.min.js"></script>
	<script type="text/javascript" src="/raw_assets/main/js/components/parallax.min.js"></script>
	<script type="text/javascript" src="/raw_assets/main/js/components/google-map.min.js"></script>
