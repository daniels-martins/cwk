...
<main>
			...
			<div class="row justify-content-sm-center">
				<div class="cl-xl-7 col-lg-8 col-md-10">
					...
					<div class="section-tittle text-center mb-70">
						<h2 class="capitalize">lets know your fancy</h2>
					</div>
				</div>
			</div>
			<div class="row">
	...
	<!-- Categories Area End -->
	<!--? Count Down Start -->
	<div class="count-down-area pt-50 pb-10 section-bg"
						...
						<div class="row justify-content-between">
							<div class="col-lg-3 col-md-6 col-sm-6">
								...
								<div class="single-counter text-center">
									...
									<p class="color-green">+ Tutorials</p>
								</div>
							</div>
							<div class="col-lg-3 col-md-6 col-sm-6">
								<!-- Counter Up -->
								<div class="single-counter text-center">
									...
									<span class="counter color-blue">40</span>
									<p class="color-blue">+ guides</p>
								</div>
							</div>
							<div class="col-lg-3 col-md-6 col-sm-6">
								<!-- Counter Up -->
