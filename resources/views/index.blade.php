...
<main>
					...
					<div class="row align-items-center">
						<div class="col-xl-6 col-lg-7 col-md-8">
							<div class="hero__caption">
								...
								<!-- Hero-btn -->
								<div class="hero__btn">
									<a href="{{ route('register') }}" class="btn hero-btn" data-animation="fadeInLeft" data-delay=".8s">
			...
			<div class="row justify-content-sm-center">
				<div class="cl-xl-7 col-lg-8 col-md-10">
					...
					<div class="section-tittle text-center mb-70">
						...
						{{-- csdojo --}}
						<div class="col-sm-4">
							{{-- this is the animate button, i should make this a blade component --}}

							<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#bigModal">Hand me the
								Modal and no one gonna hurt</button>
							{{-- here goes the modal --}}
	...
	<div class="count-down-area pt-90 pb-60 section-bg"
		data-background="/raw_assets/onlineedu/assets/img/gallery/section_bg01.png">
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-3 col-md-6 col-sm-6">
					<div class="single-team mb-30">
						<div class="team-img">
							<img src="/raw_assets/onlineedu/assets/img/gallery/team1.png" alt="">
							<!-- Blog Social -->
				...
				<div class="col-lg-3 col-md-6 col-sm-6">
					<div class="single-team mb-30">
						<div class="team-img">
							<img src="/raw_assets/onlineedu/assets/img/gallery/team2.png" alt="">
							<!-- Blog Social -->
							<ul class="team-social">
								<li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
								<li><a href="#"><i class="fab fa-twitter"></i></a></li>
				...
				<div class="col-lg-3 col-md-6 col-sm-6">
					<div class="single-team mb-30">
						<div class="team-img">
							<img src="/raw_assets/onlineedu/assets/img/gallery/team3.png" alt="">
							<!-- Blog Social -->
							<ul class="team-social">
								<li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
								<li><a href="#"><i class="fab fa-twitter"></i></a></li>
			...
			<div class="row">
				<div class="col-lg-6 col-md-12">
					<div class="about-caption mb-50">
						...
						<p>There arge many variations ohf passages of sorem gpsum ilable, but the majority have suffered alteration
							in some form, by ected humour, or randomised words whi.</p>
						<ul>
	...
	<div class="testimonial-area fix pt-180 pb-180 section-bg"
		data-background="/raw_assets/onlineedu/assets/img/gallery/section_bg03.png">
		<div class="container">
			<div class="row justify-content-center">
			...
			<div class="row">
				<div class="col-xl-6 col-lg-6 col-md-6">
					<div class="home-blog-single mb-30">
						<div class="blog-img-cap">
							<div class="blog-img">
								<img src="/raw_assets/onlineedu/assets/img/gallery/home-blog1.png" alt="">
								<!-- Blog date -->
				...
				<div class="col-xl-6 col-lg-6 col-md-6">
					<div class="home-blog-single mb-30">
						<div class="blog-img-cap">
							<div class="blog-img">
								<img src="/raw_assets/onlineedu/assets/img/gallery/home-blog2.png" alt="">
								<!-- Blog date -->
								<div class="blog-date text-center">
									<span>24</span>
									<p>Now</p>
